...
public class Medi_details extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jTextFieldSearch1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 100, 384, -1));

        jSearchBtn.setText("Search");
        jPanel1.add(jSearchBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 100, -1, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "MCode", "Batchno", "Name", "Type", "Manuf", "Price", "Quantity", "ExpireDate"
            }
        ) {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 140, 630, -1));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        String sql = "SELECT d.mcode ,batchno, name , type, manufacture , s_price , qty , exp FROM drugs d,stock s WHERE d.mcode = s.mcode ORDER BY d.mcode,exp";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Medi_details.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Medi_details().setVisible(true);
            }
        });
    }
